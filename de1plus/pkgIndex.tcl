...
package ifneeded de1_gui 1.2 [list source [file join "./" gui.tcl]]
...
package ifneeded de1_logging 1.1 [list source [file join "./" logging.tcl]]
...
package ifneeded de1_device_scale 1.4 [list source [file join "./" device_scale.tcl]]
